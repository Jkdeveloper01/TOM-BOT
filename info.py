...
CAPTION_TEXT = environ.get("CAPTION_TEXT", "<b>{file_name}\n\n⚡️Join:- [@LusiFilms]")
CAPTION_POSITION = environ.get("CAPTION_POSITION", "bottom")
...
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1001754596031').split()]
...
S_GROUP = environ.get('S_GROUP',"https://t.me/lusiGroup")
